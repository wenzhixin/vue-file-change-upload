...
var _FileUpload = require('../src/FileUpload.vue');
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('file-upload',{attrs:{"name":"file","action":"upload.php"},on:{"onAllFilesUploaded":_vm.onAllFilesUploaded,"beforeFileUpload":_vm.beforeFileUpload,"onFileProgress":_vm.onFileProgress,"afterFileUpload":_vm.afterFileUpload,"onFileError":_vm.onFileError}})}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-67971ca2", __vue__options__)
  } else {
    hotAPI.reload("data-v-67971ca2", __vue__options__)
  }
})()}
},{"../src/FileUpload.vue":70,"vue":69,"vue-hot-reload-api":68}],2:[function(require,module,exports){
var Vue = require('vue');
var Demo = require('./Demo.vue');

new Vue(Demo).$mount('#demo');

},{"./Demo.vue":1,"vue":69}],3:[function(require,module,exports){
  ...
  methods: {
    onChange: function onChange(event) {
      ...
      if (this.files.length) {
        var arrayOfPromises = this.files.map(function (file) {
          return _this._handleUpload(file);
        });
        _promise2.default.all(arrayOfPromises).then(function (allFiles) {
          _this.$emit('onAllFilesUploaded', allFiles);
        }).catch(function (err) {
          _this.$emit('onFileError', _this.files, err);
        });
      } else {
    ...
    _handleUpload: function _handleUpload(file) {
      ...
      return new _promise2.default(function (resolve, reject) {
        xhr.upload.addEventListener('progress', function (e) {
          ...
          _this2.$emit('onFileProgress', e);
        }, false);

        var onerror = function onerror() {
          var err = new Error(xhr.statusText);
          _this2.$emit('onFileError', file, err);
          reject(err);
        };
        ...
        xhr.onreadystatechange = function () {
          ...
          if (xhr.status < 400) {
            ...
            _this2.$emit('onFileUpload', file, res);
            resolve(file);
          } else {
            onerror();
          }
        ...
        xhr.open(_this2.method || 'POST', _this2.action, true);
        if (_this2.headers) {
          for (var header in _this2.headers) {
            xhr.setRequestHeader(header, _this2.headers[header]);
          }
        }
        xhr.send(form);
        _this2.$emit('afterFileUpload', file);
      });
    }
  }
};
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"file-upload"},[_c('label',{attrs:{"for":_vm.id || _vm.name}},[_c('input',{attrs:{"type":"file","name":_vm.name,"id":_vm.id || _vm.name,"accept":_vm.accept,"multiple":_vm.multiple},on:{"change":_vm.onChange}}),_vm._v(" "),_vm._t("default")],2)])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-787f0778"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-787f0778", __vue__options__)
  } else {
    hotAPI.reload("data-v-787f0778", __vue__options__)
  }
})()}
},{"babel-runtime/core-js/promise":3,"vue":69,"vue-hot-reload-api":68}],71:[function(require,module,exports){
